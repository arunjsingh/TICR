...
from app.schemas.interview import DifficultyDistribution, GenerateQuestionsResponse, QuestionOut
...
async def generate_custom_interview_questions(
    ...
    # Difficulty counters (rendered as input boxes in Swagger)
    easy_count: int = Form(0, ge=0, le=10, description="Number of easy questions"),
    medium_count: int = Form(0, ge=0, le=10, description="Number of medium questions"),
    hard_count: int = Form(0, ge=0, le=10, description="Number of hard questions"),
    ...
    if total_questions > 10:
        raise HTTPException(status_code=400, detail=f"Total requested questions ({total_questions}) exceeds the maximum limit of 10.")
